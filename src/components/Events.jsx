...
import backgroundImage from '../assets/Events-background.jpg';
        ...
        <div className="relative flex justify-center items-center py-12">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold tracking-wider">
              <span className="bg-gradient-to-r from-purple-400 via-magenta-400 to-purple-300 bg-clip-text text-transparent">
                Upcoming Events
              </span>
              <br />
              <span className="bg-gradient-to-r from-purple-400 via-magenta-400 to-purple-300 bg-clip-text text-transparent">
          ...
          {events.map((event) => (
            ...
            >
              ...
              <div className="relative p-6 h-full flex flex-col">
                ...
                {/* Register Button */}
                <button className="w-full bg-gradient-to-r from-purple-600 to-magenta-600 hover:from-purple-500 hover:to-magenta-500 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105">
                  Register Now
                </button>
              </div>
            </div>
